...
export default function LintStageDrc(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width={32} height={32} {...props}>
      ...
      <linearGradient id="a" gradientUnits="userSpaceOnUse" x1={16} y1="3.54" x2={16} y2="28.41">
        <stop offset={0} stopColor="#fce7e2" />
        <stop offset=".02" stopColor="#fad6ce" />
        <stop offset=".07" stopColor="#f5b2a4" />
        <stop offset=".13" stopColor="#f0917c" />
        <stop offset=".19" stopColor="#ec745b" />
        <stop offset=".26" stopColor="#e85c3e" />
        <stop offset=".33" stopColor="#e64827" />
        <stop offset=".42" stopColor="#e43916" />
        <stop offset=".52" stopColor="#e22f09" />
        <stop offset=".66" stopColor="#e12902" />
