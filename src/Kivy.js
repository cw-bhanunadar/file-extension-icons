...
export default function Kivy(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" width={32} height={32} {...props}>
      <defs>
        <linearGradient id="linear-gradient" x1="14.989" y1="17.164" x2="15.124" y2="17.091" gradientTransform="matrix(1, 0, 0, -1, 0, 34)" gradientUnits="userSpaceOnUse">
          <stop offset={0} stopOpacity="0.03" />
          <stop offset="0.085" stopColor="#090909" stopOpacity="0.027" />
      ...
      <circle cx={16} cy={16} r={14} style={{fill: '#3f4142'}} />
