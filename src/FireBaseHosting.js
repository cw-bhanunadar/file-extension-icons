...
export default function FireBaseHosting(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" width={32} height={32} {...props}>
      <defs>
        ...
        <linearGradient id="b" x1="9.89" y1="15.04" x2="8.62" y2="14.37" gradientTransform="translate(0 2)" gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="#a52a22" />
          <stop offset="0.4" stopColor="#a52a22" stopOpacity="0.5" />
      ...
      <g style={{clipPath: 'url(#a)'}}>
        ...
        <path d="M17.7,2.16.84.73V31.28l5.05-6.69Z" style={{opacity: '0.11999999731779099', isolation: 'isolate', fill: 'url(#b)'}} />
        <path d="M17.83,16,14.1,9,5.89,24.59Z" style={{fill: '#f47d20'}} />
        <path d="M.84.73H31.38V31.28H.84Z" style={{opacity: '0.20000000298023224', isolation: 'isolate', fill: 'url(#c)'}} />
