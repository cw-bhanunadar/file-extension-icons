...
export default function Wpml(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" width={32} height={32} {...props}>
      <defs>
        <linearGradient id="a" x1="21.531" y1="22.766" x2="25.042" y2="28.463" gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="#33879e" />
          <stop offset="0.047" stopColor="#537983" />
          <stop offset="0.105" stopColor="#726c68" />
          <stop offset="0.17" stopColor="#8e6051" />
          <stop offset="0.244" stopColor="#a4573f" />
          <stop offset="0.33" stopColor="#b55030" />
          <stop offset="0.436" stopColor="#c04b26" />
          <stop offset="0.585" stopColor="#c74821" />
