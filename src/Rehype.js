...
export default function Rehype(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width={32} height={32} {...props}>
      ...
      <path d="M25,23H22.639V17.828q0-2.806-2.067-2.807a2.237,2.237,0,0,0-1.75.813,3.03,3.03,0,0,0-.713,2.078V23H15.737V9h2.372v6.113h.041a3.809,3.809,0,0,1,3.379-1.791Q25,13.322,25,17.173Z" style={{fill: '#d2d2d2'}} />
    </svg>
  );
}
