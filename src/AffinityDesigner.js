...
export default function AffinityDesigner(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width={32} height={32} {...props}>
      ...
      <radialGradient id="a" cx="13.769" cy="17.09" r="11.945" gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#06dbe0" />
        <stop offset={1} stopColor="#3b63ff" />
      </radialGradient>
      ...
      <linearGradient id="b" gradientUnits="userSpaceOnUse" x1="15.5" y1="16.5" x2="22.3" y2={13}>
        <stop offset={0} stopColor="#1dffb8" />
        <stop offset={1} stopColor="#00d2f8" />
      </linearGradient>
