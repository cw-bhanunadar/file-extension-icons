...
export default function Falcon(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width={32} height={32} {...props}>
      ...
      <path d="M20.81,4.58c-1.24.78-3,2-5.37,3.51a60,60,0,0,0-5.83,4.18c-.81.84-1.45,3-2.94,4.82a23.7,23.7,0,0,1-3.2,3.29,9.75,9.75,0,0,0,3.2-1.23A12.56,12.56,0,0,0,10,16.35a17.63,17.63,0,0,1,1.35-1.86c1.18-1.12,5.31-2.8,7.83-3.6s3.1-.31,5.6-.78a9.72,9.72,0,0,0,3.37-1L30,3.4,20.81,6.79Z" style={{fill: '#e24329'}} />
      <path d="M30,10.55l-3.51,6.12h-2.8L16,15.12v-1L19.57,12l2.62-.42ZM12.88,16.73l-.31,3.09-1.63.48-1.71-.57Z" style={{fill: '#fc6d26'}} />
