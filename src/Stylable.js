...
export default function Stylable(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" width={32} height={32} {...props}>
      <defs>
        <linearGradient id="linear-gradient" x1="-1947.843" y1="-2006.674" x2="-1947.706" y2="-2005.516" gradientTransform="translate(25072.473 42188.473) scale(12.867 21.023)" gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="#7ad852" />
          <stop offset="0.536" stopColor="#3ab38b" />
        ...
        <linearGradient id="linear-gradient-2" x1="-1958.897" y1="-1999.713" x2="-1959.478" y2="-1998.526" gradientTransform="translate(25107.678 42025.3) scale(12.805 21.012)" gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="#ff2953" />
          <stop offset={1} stopColor="#ea3333" />
        </linearGradient>
      </defs>
      ...
      <path d="M16.26,10.018a2.819,2.819,0,0,0,.8,4.3c2.3,1.6,3.4,3.3,3.4,5.2a5.608,5.608,0,0,1-1.8,3.9c5.5-3.9,5.995-11.989.9-14.287A3.036,3.036,0,0,0,16.26,10.018Z" style={{fill: '#470000', opacity: '0.6000000238418579', isolation: 'isolate'}} />
