...
export default function Zeit(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" width={32} height={32} {...props}>
      <defs>
        <linearGradient id="a" x1="1.459" y1="32.377" x2="1.096" y2="32.82" gradientTransform="matrix(113, 0, 0, -100, -112, 3301)" gradientUnits="userSpaceOnUse">
          <stop offset={0} />
