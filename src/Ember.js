...
export default function Ember(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" width={32} height={32} {...props}>
      ...
      <path d="M23.846,19.72c-.1.68,1.23,1.61,2.12,1.59.74-.02,1.59-.37,1.47-.79s-.84.08-.91-.22c-.05-.28.84-.82.48-1.21-.34-.36-.73.57-1.13.44s.08-1.04-.42-1.09c-.58-.05-.36,1.24-.8,1.26C24.356,19.72,23.876,19.5,23.846,19.72Z" style={{fill: 'none', stroke: '#f8a38f', strokeMiterlimit: 10, strokeWidth: '0.25px'}} />
      ...
      <path d="M19.966,5.47c2.14-.2,3.4-2.42,4.71-2.08a11.817,11.817,0,0,0-2.95,3.44c-.31.42-2.36-1.31-1.76-1.36" style={{fill: '#fff8ee'}} />
      <path d="M19.966,5.47c2.14-.2,3.4-2.42,4.71-2.08a11.817,11.817,0,0,0-2.95,3.44C21.416,7.25,19.366,5.52,19.966,5.47Z" style={{fill: 'none', stroke: '#e5d0ae', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: '0.25px'}} />
      ...
      <path d="M6.556,4.98c.96-.9,2.7-.55,4.1-.04.8.28,1.84.05,1.9.22.18.38-.86,1.17-1.72,1.15C10.006,6.3,8.6,4.71,6.556,4.98Z" style={{fill: 'none', stroke: '#895b2e', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: '0.25px'}} />
      <path d="M21.426,6.53c.49.14,2.36-3.52,3.27-3.16,2.89,1.15-.88,5.57-2.07,5.67-1.2.08-1.47-2.6-1.2-2.51" style={{fill: '#fcd4c3'}} />
      <path d="M21.426,6.53c.49.14,2.36-3.52,3.27-3.16,2.89,1.15-.88,5.57-2.07,5.67C21.426,9.12,21.156,6.44,21.426,6.53Z" style={{fill: 'none', stroke: '#f8a38f', strokeMiterlimit: 10, strokeWidth: '0.25px'}} />
      <path d="M10.986,6.09c-.8.35-3.63-2.62-4.83-.71-.79,1.26,1.6,3.8,3.3,4.07,1.72.27,1.95-3.55,1.53-3.36" style={{fill: '#fcd4c3'}} />
      <path d="M10.986,6.09c-.8.35-3.63-2.62-4.83-.71-.79,1.26,1.6,3.8,3.3,4.07C11.176,9.72,11.406,5.9,10.986,6.09Z" style={{fill: 'none', stroke: '#f8a38f', strokeMiterlimit: 10, strokeWidth: '0.25px'}} />
      ...
      <g style={{clipPath: 'url(#aa)'}}>
        <g style={{opacity: '0.5'}}>
          <path d="M9.226,9.07c-.1.13-.16,2.07.66,2.59a6.056,6.056,0,0,0,3.27.02,3.475,3.475,0,0,0,1.21-2.51c-.33-.44-2.69-1.02-4.46-.56A1.644,1.644,0,0,0,9.226,9.07Z" style={{fill: 'none', stroke: '#333', strokeMiterlimit: 10}} />
        </g>
      </g>
      ...
      <g style={{clipPath: 'url(#ab)'}}>
        <g style={{opacity: '0.5'}}>
          <path d="M22.6,9.91c.09.14-.11,2.07-.98,2.49a6.177,6.177,0,0,1-3.24-.4,3.491,3.491,0,0,1-.89-2.65c.38-.39,2.8-.66,4.5.02A1.689,1.689,0,0,1,22.6,9.91Z" style={{fill: 'none', stroke: '#333', strokeMiterlimit: 10}} />
        </g>
      </g>
