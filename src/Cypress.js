  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width={32} height={32} {...props}>
      ...
      <path id="_Path_" data-name="<Path>
        " d="M16.075,3.588A12.48,12.48,0,1,1,3.6,16.068a12.473,12.473,0,0,1,12.48-12.48Z" style={{fill: '#4a4a4d'}} />
          ...
          <path id="_Path_2" data-name="<Path>
            ...
            <g id="_Group_2" data-name="<Group>
              ...
              <path id="_Path_3" data-name="<Path>
                " d="M16.075,3.588A12.48,12.48,0,1,1,3.6,16.068a12.473,12.473,0,0,1,12.48-12.48Z" style={{fill: '#fff'}} />
                <path d="M16.075,28.775A12.707,12.707,0,1,1,28.782,16.068,12.721,12.721,0,0,1,16.075,28.775Zm0-24.959A12.253,12.253,0,1,0,28.328,16.068,12.267,12.267,0,0,0,16.075,3.815Z" style={{fill: '#fff'}} />
              </g>
            </g>
            <path id="_Path_4" data-name="<Path>
              " d="M22.7,21.559a6.555,6.555,0,0,1-2.088,3.222A6.827,6.827,0,0,1,16.8,26.1l-.318-2.088a5.141,5.141,0,0,0,2.314-.726,5.873,5.873,0,0,0,.545-.545h0L15.576,10.668h3.131L20.886,19.7,23.2,10.668h3.041L22.7,21.559Z" style={{fill: '#fff'}} />
