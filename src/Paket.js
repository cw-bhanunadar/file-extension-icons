...
export default function Paket(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" width={32} height={32} {...props}>
      ...
      <path d="M18.558,49.816c.061-.183-7-7.561-7-7.561" style={{fill: 'none', strokeLinecap: 'round', strokeWidth: '76.7170028686524px', stroke: 'url(#a)'}} />
      <path d="M8.558,56.835s9.942-6.825,10-7" style={{fill: '#2aa7c9', strokeLinecap: 'round', strokeWidth: '76.7170028686524px', stroke: 'url(#b)'}} />
      <path d="M8.73,57.121H9.854" style={{fill: 'none', strokeLinecap: 'round', strokeWidth: '100px', stroke: 'url(#c)'}} />
    </svg>
  );
}
