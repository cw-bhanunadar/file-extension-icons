...
export default function Aurelia(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" width={32} height={32} {...props}>
      <defs>
        ...
        <linearGradient id="c" x1="-74.781" y1="-34.695" x2="-70.958" y2="-40.015" gradientTransform="matrix(8.637, 0, 0, -7.94, 632.817, -284.546)" xlinkHref="#a" />
        <linearGradient id="d" x1="-3.96" y1="41.901" x2="31.012" y2="13.213" gradientTransform="matrix(1, 0, 0, 1, 0, 0)" xlinkHref="#a" />
        <linearGradient id="e" x1="-72.241" y1="-41.388" x2="-69.334" y2="-43.773" gradientTransform="matrix(6.504, 0, 0, -6.517, 478.263, -265.393)" xlinkHref="#a" />
        <linearGradient id="f" x1="-74.154" y1="-34.519" x2="-70.411" y2="-37.816" gradientTransform="matrix(10.02, 0, 0, -10.013, 732.69, -346.247)" xlinkHref="#a" />
        <linearGradient id="g" x1="-74.562" y1="-31.575" x2="-75.704" y2="-30.013" gradientTransform="matrix(15.678, 0, 0, -16.922, 1195.287, -503.63)" xlinkHref="#b" />
        <linearGradient id="h" x1="-73.124" y1="-36.529" x2="-68.938" y2="-41.164" gradientTransform="matrix(7.887, 0, 0, -8.589, 578.148, -327.094)" xlinkHref="#a" />
