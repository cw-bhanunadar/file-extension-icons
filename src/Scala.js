...
export default function Scala(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" width={32} height={32} {...props}>
      <defs>
        <radialGradient id="a" cx="-36.176" cy="-852.913" r="48.27" gradientTransform="matrix(0.36, 0.402, 0.222, -0.163, 183.598, -112.345)" gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="#7ce1ff" />
          <stop offset="0.3" stopColor="#7ce1ff" stopOpacity={0} />
        </radialGradient>
        <radialGradient id="b" cx="4165.973" cy="-1221.763" r="83.239" gradientTransform="matrix(0.031, 0.03, 0.075, -0.062, -58.724, -179.88)" gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="#7ce1ff" />
          <stop offset={1} stopColor="#7ce1ff" stopOpacity={0} />
        </radialGradient>
        ...
        <linearGradient id="e" x1="-134.907" y1="-172.628" x2="-134.896" y2="-172.628" gradientTransform="translate(207495 99574.75) scale(1538 576.75)" xlinkHref="#d" />
        ...
        <linearGradient id="g" x1="-134.907" y1="-171.781" x2="-134.896" y2="-171.781" gradientTransform="translate(207495 165132) scale(1538 961.25)" xlinkHref="#f" />
        <linearGradient id="h" x1="-134.907" y1="-173.363" x2="-134.896" y2="-173.363" gradientTransform="translate(207495 166670) scale(1538 961.25)" xlinkHref="#f" />
      </defs>
      <title>file_type_scala</title>
      <path d="M-15.442,15.816c.061-.183-7-7.561-7-7.561" style={{fill: 'none', strokeLinecap: 'round', strokeWidth: '76.71700286865234px', stroke: 'url(#a)'}} />
      <path d="M-25.442,22.835s9.942-6.825,10-7" style={{fill: '#2aa7c9', strokeLinecap: 'round', strokeWidth: '76.71700286865234px', stroke: 'url(#b)'}} />
      <path d="M-25.27,23.121h1.124" style={{fill: 'none', strokeLinecap: 'round', strokeWidth: '100px', stroke: 'url(#c)'}} />
