...
export default function Retext(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width={32} height={32} {...props}>
      ...
      <path d="M23,22.173a3.874,3.874,0,0,1-1.724.327q-2.871,0-2.87-2.754V14.17H16.759V12.418h1.647V10.136L20.64,9.5v2.918H23V14.17H20.64V19.1a1.944,1.944,0,0,0,.318,1.252,1.321,1.321,0,0,0,1.06.375A1.538,1.538,0,0,0,23,20.4Z" style={{fill: '#d2d2d2'}} />
    </svg>
  );
}
