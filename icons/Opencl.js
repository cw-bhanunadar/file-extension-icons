...
export default function Opencl(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" width={32} height={32} {...props}>
      <defs>
        ...
        <linearGradient id="c" x1="18.466" y1="6.619" x2="15.924" y2="13.603" gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="#cfa40c" />
          <stop offset={1} stopColor="#edd480" />
        </linearGradient>
        ...
        <linearGradient id="f" x1="5.505" y1="11.477" x2="8.546" y2="14.519" gradientUnits="userSpaceOnUse">
          <stop offset={0} stopColor="#11a119" />
          <stop offset={1} stopColor="#37ae3d" />
        </linearGradient>
